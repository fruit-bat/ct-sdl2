...
SetupWindowData(_THIS, SDL_Window * window, Window w, BOOL created)
{
    ...
    data->last_xconfigure.x = -999;
    data->last_xconfigure.y = -999;
...
// We seem to randomly get window focus on window creation. 
// Never get window focus with 2 joysticks connected (WTF)        
//        if (FocalWindow==w)
        {
...
{
  printf("SetWindowBordered(Display *display, int screen, Window window, SDL_bool border)\n");
    /*
...
{
  printf("X11_SetWindowBordered(_THIS, SDL_Window * window, SDL_bool bordered)\n");
...
{
  printf("X11_SetWindowFullscreenViaWM(_THIS, SDL_Window * window, SDL_VideoDisplay * _display, SDL_bool fullscreen)\n");
    SDL_WindowData *data = (SDL_WindowData *) window->driverdata;
...
{
  printf("X11_BeginWindowFullscreenLegacy(_THIS, SDL_Window * window, SDL_VideoDisplay * _display)\n");
    SDL_WindowData *data = (SDL_WindowData *) window->driverdata;
    SDL_DisplayData *displaydata = (SDL_DisplayData *) _display->driverdata;
...
{
  printf("X11_SetWindowFullscreen(_THIS, SDL_Window * window, SDL_VideoDisplay * _display, SDL_bool fullscreen)\n");
    /* !!! FIXME: SDL_Hint? */
